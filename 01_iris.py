...
from data_util import get_iris
...
PARAM_BOUNDS = [
    IntegerVar(lb=2, ub=100, name="size_hidden"),
    ...
    # StringVar(valid_sets=("MPI", "OLS", "L2"), name="trainer"),
    # FloatVar(lb=0.01, ub=1.0, name="alpha")
]
...
def run_trial(model, seed, data, param_bounds):
    ...
    # Initialize model
    tuner = GfoRvflTuner(problem_type="classification", bounds=param_bounds, cv=3, scoring="F1S",
