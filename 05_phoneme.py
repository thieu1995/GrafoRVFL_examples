...
from graforvfl import DataTransformer, GfoRvflTuner, Data
from mealpy import IntegerVar, StringVar, FloatVar
from data_util import get_phoneme

## Load data object
# 5404 samples, 5 features, 2 classes
X_train, X_test, y_train, y_test = get_phoneme()
...
y_train, y_scaler = Data.encode_label(y_train)
...
PARAM_BOUNDS = [
    IntegerVar(lb=5, ub=200, name="size_hidden"),
