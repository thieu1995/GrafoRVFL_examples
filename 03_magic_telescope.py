...
if __name__ == "__main__":
    ...
    df_loss.to_csv(f"{Config.PATH_SAVE}/{Config.DATA_03}/{Config.RESULT_LOSS}", index=False, header=True)
    df_result.to_csv(f"{Config.PATH_SAVE}/{Config.DATA_03}/{Config.RESULT_METRICS}", index=False, header=True)
    df_best_params.to_csv(f"{Config.PATH_SAVE}/{Config.DATA_03}/{Config.RESULTS_PARAMS}", index=False, header=True)
